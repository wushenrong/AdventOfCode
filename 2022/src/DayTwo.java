...
public class DayTwo {
    public static void main(String[] args) {
        ArrayList<String> strategy = Utilities.readFile("DayTwo.txt");
    ...
    public static int calculateBasicStrategy(ArrayList<String> strategy) {
        ...
        for (String round : strategy) {
            ...
            if ((homeRock && opponentRock)
                    || (homePaper && opponentPaper)
                    || (homeScissors && opponentScissors)) {
                score += 3;
            } else if ((homeRock && opponentScissors)
                    || (homePaper && opponentRock)
